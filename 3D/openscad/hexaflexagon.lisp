...
(scad:emit
 ...
 :file "/home/dr/software/blueprints/3D/openscad/hexaflexagon_connectors.scad"
 :fn 20)

;; triangles
(scad:emit
 (scad:scad-union
  (loop for i from 0 to 1 collecting
	 (loop for j from 0 to 4 collecting
		  (scad:translate (* i 2 *center-to-corner*) (* j 1.3 *side-length*) 0 (hinged-triangle '(0 1))))))
 :file "/home/dr/software/blueprints/3D/openscad/hexaflexagon_triangles.scad"
 :fn 20)
